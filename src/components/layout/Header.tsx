          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-auto px-4">
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-4 z-10">
                ...
                {/* Twitter / X */}
                <a href="#" className="flex flex-col items-center justify-center gap-3 py-6 bg-[#292a2c]/80 hover:bg-[#38393b] hover:-translate-y-1 hover:shadow-xl rounded-[24px] transition-all group duration-300">
